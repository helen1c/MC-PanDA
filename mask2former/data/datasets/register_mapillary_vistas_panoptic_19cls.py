...
MAPILLARY_VISTAS_SEM_SEG_CATEGORIES = CITYSCAPES_CATEGORIES
...
def load_mapillary_vistas_panoptic_json(json_file, image_dir, gt_dir, semseg_dir, meta):
    ...
    # just for debugging
    # valid_image_ids = [ann["image_id"] for ann in json_info["annotations"]][:50]
...
_PREDEFINED_SPLITS_ADE20K_PANOPTIC = {
    "mapillary_vistas_panoptic_val_19cls": (
        "mapillary_vistas/validation/images",
        "mapillary_vistas/validation19cls",
        "mapillary_vistas/validation19cls/panoptic_validation_19cls.json",
...
def register_all_mapillary_vistas_panoptic_19cls(root):
...
register_all_mapillary_vistas_panoptic_19cls(_root)
